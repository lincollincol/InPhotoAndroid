...
sealed class StoryContentSource(
    @StringRes value: Int,
    enabled: Boolean,
    ...
    @Parcelize
    object Camera : StoryContentSource(
        R.string.option_avatar_camera,
        true,
        R.drawable.ic_camera
    )

    @Parcelize
    object Gallery : StoryContentSource(
        R.string.option_avatar_gallery,
        true,
        R.drawable.ic_image
    )
